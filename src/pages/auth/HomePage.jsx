...
import { bus_home, covid, live_track, qr } from "../../assets/img";
...
<div>
  ...
  <p>{item?.desc}</p>
          ...
          {/* <div style={{}}> */}
        {/* <div style={{ marginTop: "7%", marginBottom: "7%", marginLeft:'10%', marginRight:'10' }}>
            {data.map((item) => (
              <div className="main-cards-booking">
                <div
  ...
  <div className="main-cards-booking">
    {data.map((item) => (
      <div className="card p-3 m-2" style={{ boxShadow: "2px 2px 2px 2px #E8E8E8", width:'24rem'}}>
